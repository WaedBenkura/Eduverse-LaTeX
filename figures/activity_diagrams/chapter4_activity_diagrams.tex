...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  ...
  \draw[ch4 rebuilt card] (-74,-48) rectangle (-25,-102);
  ...
  \draw[ch4 rebuilt card] (25,-48) rectangle (74,-102);
  \node[ch4 rebuilt title] at (29,-55) {Reset access};
  \node (reset) [ch4 rebuilt step narrow] at (49,-69) {Request password reset.};
  \node (newpass) [ch4 rebuilt step narrow] at (49,-91) {Set the new password.};

  \node (valid) [ch4 rebuilt decision] at (0,-122) {Access accepted?};
  \node (error) [ch4 rebuilt step narrow] at (56,-133) {Error message is shown.};
  \node (errorend) [edu final] at (56,-156) {};
  \node (context) [ch4 rebuilt step wide] at (0,-151) {Select active organization or role if needed.};
  \node (workspace) [ch4 rebuilt step wide] at (0,-174) {Dashboard or workspace is displayed.};
  \node (logout) [ch4 rebuilt step wide] at (0,-197) {User works in the selected context and logs out.};
  \node (end) [edu final] at (0,-218) {};
  ...
  \path [edu arrow] (verify.south) |- (valid.west);
  \path [edu arrow] (signin) -- (valid);
  \path [edu arrow] (newpass.south) |- (valid.east);
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  \node (start) [edu initial] at (0,0) {};
  \node (open) [ch4 rebuilt step wide] at (0,-12) {User opens class materials.};
  \node (shown) [ch4 rebuilt step wide] at (0,-25) {Materials are displayed.};
  \node (select) [ch4 rebuilt step wide] at (0,-38) {User selects a materials action.};
  ...
  \node (manage) [ch4 rebuilt step narrow] at (-50,-83) {Manage material.};
  ...
  \node (publish) [ch4 rebuilt step narrow] at (-31,-145) {Save or publish.};
  ...
  \node (browse) [ch4 rebuilt step narrow] at (0,-87) {Browse, search, or filter materials.};
  \node (preview) [ch4 rebuilt step narrow] at (0,-114) {Preview, open, or download material.};
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  ...
  \node (lowerfork) [ch4 rebuilt fork, minimum width=58mm] at (0,-160) {};
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  ...
  \node (submit) [ch4 rebuilt step wide] at (0,-158) {Student submits text, file, or combined work.};
  \node (resubmit) [ch4 rebuilt decision] at (0,-179) {Resubmission needed and allowed?};
  \node (update) [ch4 rebuilt step narrow] at (49,-179) {Update the submission.};
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  ...
  \node (configure) [ch4 rebuilt step wide] at (0,-45) {Create or edit exam, questions, passcode, timing, and integrity settings.};
  ...
  \draw[ch4 rebuilt card] (-66,-244) rectangle (66,-332);
  ...
  \node (validattempt) [ch4 rebuilt decision] at (0,-305) {Release result or void/retake?};
  \node (release) [ch4 rebuilt step narrow] at (-42,-330) {Student views released result and answer review.};
  \node (retake) [ch4 rebuilt step narrow] at (42,-330) {Void or retake message is shown.};
  \node (releaseend) [edu final] at (-42,-352) {};
  \node (retakeend) [edu final] at (42,-352) {};
  ...
  \path [edu arrow] (validattempt.west) -| node[edu label, pos=0.25] {Release} (release.north);
  \path [edu arrow] (validattempt.east) -| node[edu label, pos=0.25] {Void/retake} (retake.north);
  \path [edu arrow] (release) -- (releaseend);
  \path [edu arrow] (retake) -- (retakeend);
\end{tikzpicture}%
}
...
\begin{tikzpicture}[edu activity, node distance=8.5mm and 28mm]
  \node (start) [edu initial] {};
  \node (open) [ch4 act step, below=9mm of start] {Teacher or Organization Administrator opens the Sessions page.};
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  \node (start) [edu initial] at (0,0) {};
  \node (open) [ch4 rebuilt step wide] at (0,-12) {User opens the dashboard or Results area.};
  \node (shown) [ch4 rebuilt step wide] at (0,-26) {Role-specific dashboard is displayed.};
  \node (select) [ch4 rebuilt step wide] at (0,-40) {Select result view.};
  \node (fork) [ch4 rebuilt fork, minimum width=88mm] at (0,-54) {};

  \draw[ch4 rebuilt card] (-72,-66) rectangle (-4,-171);
  \node[ch4 rebuilt title] at (-68,-73) {Student branch};
  \node (released) [ch4 rebuilt decision] at (-38,-92) {Results released or visible?};
  \node (hidden) [ch4 rebuilt step narrow] at (-57,-119) {Unavailable results remain hidden or marked not released.};
  \node (hiddenend) [edu final] at (-57,-144) {};
  \node (grades) [ch4 rebuilt step narrow] at (-19,-119) {View assignment grades and feedback.};
  \node (exams) [ch4 rebuilt step narrow] at (-19,-148) {View released exam results and answer review where allowed.};
  \node (studentend) [edu final] at (-19,-167) {};

  \draw[ch4 rebuilt card] (4,-66) rectangle (72,-171);
  \node[ch4 rebuilt title] at (8,-73) {Teacher/Admin branch};
  \node (staffopen) [ch4 rebuilt step] at (38,-95) {Open class, assignment, or exam results.};
  \node (staffreview) [ch4 rebuilt step] at (38,-126) {Review results according to visibility rules.};
  \node (staffend) [edu final] at (38,-154) {};
  ...
  \path [edu arrow] (released.east) -| node[edu label, pos=0.25] {Yes} (grades.north);
  \path [edu arrow] (grades) -- (exams);
  \path [edu arrow] (exams) -- (studentend);
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  ...
  \node (request) [ch4 rebuilt step wide] at (0,-173) {Request assignment guidance or drafting assistance.};
  \node (task) [ch4 rebuilt decision] at (0,-192) {Drafting task?};
  \node (guidance) [ch4 rebuilt step narrow] at (-48,-215) {Request assignment guidance.};
  ...
  \path [edu arrow] (task.west) -| node[edu label, pos=0.25] {Guidance} (guidance.north);
  ...
  \path [edu arrow] (guidance.south) |- (draftout.west);
