...
are sufficiently stable to document in an academic manner. The chapter
structure is retained so that the database design can be situated clearly
within the broader system-design discussion.
...
metadata for synchronous learning. This section establishes the context for the
detailed data design discussed in Section~\ref{sec:data_and_storage_design}.
