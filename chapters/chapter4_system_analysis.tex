...
The diagrams in this chapter focus on the three principal human actors. The
system itself is not drawn as a separate actor in every diagram; automatic
responsibilities such as access enforcement, notification generation,
...
No separate activity diagram is provided for the Project Overview because it
represents a system-level summary rather than a single workflow.
