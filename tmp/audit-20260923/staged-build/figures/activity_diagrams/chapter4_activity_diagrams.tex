...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  ...
  \node (fork) [ch4 rebuilt fork, minimum width=142mm] at (0,-54) {};

  \draw[ch4 rebuilt card] (-92,-66) rectangle (-28,-204);
  \node[ch4 rebuilt title] at (-88,-73) {A. Manage material};
  \node (manage) [ch4 rebuilt step narrow] at (-60,-89) {Teacher/Admin manages material.};
  \node (managechoice) [ch4 rebuilt decision] at (-60,-114) {Upload or delete?};
  \node (delete) [ch4 rebuilt step narrow] at (-79,-144) {Delete selected material.};
  \node (details) [ch4 rebuilt step narrow] at (-41,-144) {Enter details and attach file.};
  \node (publish) [ch4 rebuilt step narrow] at (-41,-169) {Publish material.};
  \node (updated) [ch4 rebuilt step] at (-60,-194) {Updated materials are shown.};
  \node (manageend) [edu final] at (-60,-216) {};

  \draw[ch4 rebuilt card] (-22,-66) rectangle (22,-166);
  \node[ch4 rebuilt title] at (-18,-73) {B. View material};
  \node (browse) [ch4 rebuilt step narrow] at (0,-94) {Student browses, searches, or filters materials.};
  \node (preview) [ch4 rebuilt step narrow] at (0,-128) {Student previews, opens, or downloads material.};
  \node (viewend) [edu final] at (0,-157) {};

  \draw[ch4 rebuilt card] (28,-66) rectangle (92,-214);
  \node[ch4 rebuilt title] at (32,-73) {C. AI summary};
  \node (aiopen) [ch4 rebuilt step narrow] at (60,-89) {Choose AI support.};
  \node (aiq) [ch4 rebuilt decision] at (60,-114) {AI summary enabled?};
  \node (blocked) [ch4 rebuilt step narrow] at (41,-144) {Unavailable message is shown.};
  \node (summary) [ch4 rebuilt step narrow] at (79,-144) {Generate or open summary.};
  \node (aiout) [ch4 rebuilt step narrow] at (79,-176) {AI output is displayed.};
  \node (blockedend) [edu final] at (41,-176) {};
  \node (aiend) [edu final] at (79,-207) {};
...
\begin{tikzpicture}[edu activity, x=1mm, y=1mm]
  \draw[ch4 rebuilt card] (-82,8) rectangle (82,-68);
  \node[ch4 rebuilt title] at (-78,1) {AI availability};
  \node (start) [edu initial] at (0,-4) {};
  \node (select) [ch4 rebuilt step wide] at (0,-18) {User selects an AI-related action.};
  \node (enabled) [ch4 rebuilt decision] at (0,-38) {AI enabled for current organization and class?};
  \node (blocked) [ch4 rebuilt step narrow] at (56,-38) {AI unavailable message is shown.};
  \node (blockedend) [edu final] at (56,-60) {};
  \node (category) [ch4 rebuilt step wide] at (0,-60) {Choose AI support category.};
  \node (fork) [ch4 rebuilt fork, minimum width=146mm] at (0,-82) {};

  \draw[ch4 rebuilt card] (-82,-94) rectangle (-8,-160);
  \node[ch4 rebuilt title] at (-78,-101) {A. Class AI Agent};
  \node (ask) [ch4 rebuilt step] at (-45,-118) {Ask the Class AI Agent.};
  \node (askout) [ch4 rebuilt step] at (-45,-144) {AI response is displayed using the current class context.};
  \node (askend) [edu final] at (-45,-158) {};

  \draw[ch4 rebuilt card] (8,-94) rectangle (82,-160);
  \node[ch4 rebuilt title] at (12,-101) {B. Study support};
  \node (summary) [ch4 rebuilt step] at (45,-118) {Generate material summary.};
  \node (studyout) [ch4 rebuilt step] at (45,-144) {AI study support is displayed using the current class context.};
  \node (studyend) [edu final] at (45,-158) {};

  \draw[ch4 rebuilt card] (-82,-178) rectangle (82,-286);
  \node[ch4 rebuilt title] at (-78,-185) {C. Drafting and feedback support};
  \node (request) [ch4 rebuilt step wide] at (0,-202) {Request assignment support or drafting assistance.};
  \node (task) [ch4 rebuilt decision] at (0,-226) {Selected support type?};
  \node (support) [ch4 rebuilt step narrow] at (-52,-258) {Request assignment support.};
  \node (draft) [ch4 rebuilt step narrow] at (0,-258) {Generate assignment or exam draft if enabled.};
  \node (feedback) [ch4 rebuilt step narrow] at (52,-258) {Generate draft feedback if supported.};
  \node (draftout) [ch4 rebuilt step wide] at (0,-286) {Draft AI output is displayed for user review.};
  \node (draftend) [edu final] at (0,-307) {};
  ...
  \path [edu arrow] (fork.west) -| (ask.north);
  \path [edu arrow] (fork.east) -| (summary.north);
